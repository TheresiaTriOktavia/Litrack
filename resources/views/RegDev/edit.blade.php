    ...
    <div class="content-wrapper">
            ...
            <div class="col-md-12 grid-margin">
                <div class="row">
                    <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                        <h3 class="font-weight-bold text-primary">Edit Device</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card shadow-sm rounded-10">
            <div class="card-header bg-dark text-white" style="border-top-left-radius: 1rem; border-top-right-radius: 1rem;">
                <h5 class="mb-0"><i class="mdi mdi-pencil-circle mr-2"></i> Edit Device</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('devices.update', $device->id_dev) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="form-group">
                        <label for="nama_dev">Device Name</label>
                        <input type="text" class="form-control" id="nama_dev" name="nama_dev"
                            value="{{ $device->nama_dev }}" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="ket" name="ket" rows="3">{{ $device->ket }}</textarea>
                    </div>
